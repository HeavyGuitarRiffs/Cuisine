...
export const PrevButton = ({ disabled, children, ...restProps }) => {
  return (
    <button
      className={`embla__button embla__button--prev ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`}
      type="button"
      disabled={disabled}
      {...restProps}
    >
...
export const NextButton = ({ disabled, children, ...restProps }) => {
  return (
    <button
      className={`embla__button embla__button--next ${disabled ? 'opacity-50 cursor-not-allowed' : ''}`}
      type="button"
      disabled={disabled}
      {...restProps}
    >
